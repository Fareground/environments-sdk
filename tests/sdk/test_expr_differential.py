...
``FG_ENV_EXPR_ORACLE=1 pytest tests/sdk`` runs the whole suite the same way.
"""
import json
import random
...
from fg_env.sdk.actions import ActionSpec
from fg_env.sdk.effects import split_statement, statement_parts
from fg_env.sdk.errors import RunError
from fg_env.sdk.expr import ExprError, Scope, Untrusted, compile_expr
from fg_env.sdk.game.steps import apply_step, random_step
from fg_env.sdk.template import compile_template, render

CONTRACTS = Path(__file__).parents[2] / "examples" / "contracts"
