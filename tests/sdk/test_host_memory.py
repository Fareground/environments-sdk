...
from fg_env.sdk.host.stubs import StubRanker, StubWriter
from fg_env.sdk.mechanisms.memory import lexical_relevance
...
def test_recall_strengthens_what_it_returns_and_recency_decays():
    ...
    from fg_env.sdk.mechanisms.memory import _recency
