...
- `start` (default 0.0): Value at round 1.
- `drift` (default 0.0): Added each step (form add) or log growth each step (form multiply).
- `sd` (default 1.0): Standard deviation of each step's change (of its log with form multiply).
- `form` (default "add"): add: x + drift + sd·z | multiply (geometric): x·e^(drift + sd·z).
