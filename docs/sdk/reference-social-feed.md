...
```json
{"types": {"moderator": {"agent": true}, "account": {"agent": true}}, "entities": {"mod": {"type": "moderator"}, "account": {"type": "account", "count": 2}}, "mechanisms": {"my_feed": {"kind": "social", "mode": "feed", "who": "account", "feed_size": 6, "moderators": "moderator", "downrank": {"labels": ["misleading"], "factor": 0.2}}}}
```
