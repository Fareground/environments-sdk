...
- `stage` (default null): Rank during this declared stage and match when it ends, after the stage's own on_exit effects (every time); default: a stage named after the mechanism, once.
