...
```json
{"types": {"school": {"agent": true, "props": {"capacity": 2}}, "student": {"agent": true}}, "entities": {"school": {"type": "school", "count": 2}, "student": {"type": "student", "count": 2}}, "mechanisms": {"my_matching": {"kind": "groups", "mode": "matching", "who": "student", "to": "school", "seats": "$it.capacity"}}}
```
