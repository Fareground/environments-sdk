...
```json
{"entities": {"u1": {"type": "account"}, "u2": {"type": "account"}}, "relations": {"follows": {"links": [{"from": "u2", "to": "u1"}]}}, "types": {"account": {"agent": true}}, "mechanisms": {"my_diffusion": {"kind": "social", "mode": "diffusion", "who": "account", "over": "follows", "flow": "against", "model": "cascade", "p": 0.1, "seeds": {"rumor": ["u1"]}}}}
```
