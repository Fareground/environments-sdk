...
```json
{"world": {"truth": "yes"}, "mechanisms": {"my_prediction": {"kind": "market", "mode": "prediction", "who": "forecaster", "outcomes": ["yes", "no"], "maker": "lmsr", "liquidity": 50, "question": "Will the bill pass?", "resolve_at": 5, "outcome": "$world.truth"}}}
```
