...
```json
{"entities": {"player": {"type": "player", "count": 5}}, "types": {"player": {"agent": true}}, "mechanisms": {"my_roles": {"kind": "groups", "mode": "roles", "who": "player", "deck": {"werewolf": 2, "seer": 1, "villager": "rest"}, "teams": {"wolves": ["werewolf"], "village": ["seer", "villager"]}, "know": ["wolves"], "actions": {"inspect_player": {"roles": ["seer"], "params": {"target": {"type": "entity", "of": "player"}}, "do": ["$seen = $params.target.role"], "outcome": "{$params.target.name} is {$seen}."}}}}}
```
