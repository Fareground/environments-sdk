...
- `fields`: object — {field: type}; a field holds what a property of its type holds, by the same rules (a number field refuses text, a text field a number). Text fields written by agents are marked untrusted.
