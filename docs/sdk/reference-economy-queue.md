...
```json
{"mechanisms": {"my_queue": {"kind": "economy", "mode": "queue", "unit": "second", "interval": 1800, "channels": {"calls": {"arrivals": "$inputs.calls[$interval]", "service": {"dist": "lognormal", "mean": 380, "cv": 0.6}, "patience": {"mean": 160}, "threshold": 20, "target": 0.8, "callback": {"when": 90, "accept": 0.6}}}, "servers": {"agents": {"staff": "$inputs.staffing[$interval]", "cost": 26, "shrinkage": 0.3}}}}}
```
