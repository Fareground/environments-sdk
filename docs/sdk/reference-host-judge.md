...
```json
{"types": {"debater": {"agent": true, "props": {"score": 0}}}, "records": {"speeches": {"fields": {"text": "text"}}}, "actions": {"speak": {"by": "debater", "params": {"text": {"type": "text"}}, "do": [{"post": "speeches", "text": "$params.text"}]}}, "mechanisms": {"my_judge": {"kind": "host", "mode": "judge", "record": "speeches", "who": "debater", "into": "score", "criteria": {"logic": {"weight": 2}, "evidence": {"scale": [1, 5]}}, "instructions": "Judge each debate speech on its merits."}}}
```
