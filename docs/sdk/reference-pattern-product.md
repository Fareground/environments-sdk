...
- `scale` (default 1.0): Multiplies the product (a base level).
...
```json
{"mechanisms": {"my_product": {"kind": "pattern", "mode": "product", "of": ["trend", {"pattern": "season", "key": "$row.category"}], "scale": "$row.base", "table": "$inputs.skus", "column": "sku"}}}
```
