...
- `at` (required): The tipping point.
- `below` (default 0.0): Value below it.
- `above` (default 1.0): Value above it.
- `width` (default 0.0): 0: a hard switch | > 0: a smooth one over about this width.
