...
name yourself to replace a generated part, a named event or end entry included; two mechanisms
generating one name is an error). A declared stage that offers only mechanisms' actions and sets no
