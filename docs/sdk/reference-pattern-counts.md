...
- `dist` (default "negative_binomial"): poisson: variance = mean | negative_binomial: variance = mean + mean²/dispersion (over-dispersed).
- `dispersion` (default 10.0): negative_binomial: k; smaller is noisier (fitted by the method of moments).
...
```json
{"types": {}, "mechanisms": {"my_counts": {"kind": "pattern", "mode": "counts", "dist": "negative_binomial", "dispersion": 6}}}
```
