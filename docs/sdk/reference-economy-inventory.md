...
```json
{"types": {"villager": {"agent": true, "props": {"hunger": 10}}}, "entities": {"villager": {"type": "villager", "count": 2}}, "mechanisms": {"my_inventory": {"kind": "economy", "mode": "inventory", "who": "villager", "capacity": 20, "items": {"bread": {"value": 3, "shelf_life": 4, "on_consume": ["$actor.hunger -= 2 * $qty"]}, "axe": {"unique": true, "value": 20, "props": {"durability": 10}}}}}}
```
