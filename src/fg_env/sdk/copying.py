"""Copying a run: the part of :class:`~fg_env.sdk.runtime.Env` that clones and forks it."""
...
class Copying:
    """Clones and forks of a run (see :mod:`fg_env.sdk.branch` and :mod:`fg_env.sdk.fork`)."""
