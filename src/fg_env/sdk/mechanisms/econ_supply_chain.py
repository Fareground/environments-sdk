...
class SupplyChainConfig(BaseModel):
    ...
    initial_flow: Union[float, str] = Field(0, description="Steady flow already in every pipeline when the run starts.")
    holding_cost: Union[float, str] = Field(0, description="Cost per unit in stock per round.")
