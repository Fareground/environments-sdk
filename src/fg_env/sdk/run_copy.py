...
_WORLD_FIELDS = frozenset({
    ...
    "_type_props", "_def_cache", "_def_cache_state", "_def_cache_on", "_remembered", "_remembered_state", "_subtypes", "types", "assets", "patterns"})
...
def _copy_world(source: SdkWorld) -> SdkWorld:
    ...
    world.__dict__.update(
        ...
        _record_seq=source._record_seq, _type_props=source._type_props, _def_cache={}, _def_cache_state=None, _remembered={}, _remembered_state=None,
