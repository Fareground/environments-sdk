...
SDK; the reference adapters in :mod:`fg_env.sdk.host.adapters` wrap your own client object, and
:mod:`fg_env.sdk.host.stubs` holds deterministic stand-ins for tests.
