...
class SdkWorld(World):
    ...
    def __init__(self, contract: Contract, inputs: Dict[str, Any], seeds: SeedTree, arm: Optional[str] = None):
        ...
        #: How many times each draw site has drawn this round (see :class:`~fg_env.seeds.DrawSite`).
        ...
        #: What each agent was shown (an :class:`~fg_env.exposure.ExposureLog`), when the run records it.
