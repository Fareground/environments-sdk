...
The language lives in a few modules, all re-exported here: :mod:`.base` (errors, provenance, budgets),
:mod:`.scope` (world and scope), :mod:`.values` (value access and operators), :mod:`.calls`
(built-in function registry) and :mod:`.compile` (parsing and compilation).
"""
...
from .values import _describe, _entity_id, _number, _pow, attr, map_key  # noqa: F401
