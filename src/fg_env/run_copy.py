...
_WORLD_FIELDS = frozenset({
    ...
    "_type_props", "_private", "_hidden", "private_names", "private_metrics", "hidden_reads", "_def_cache", "_def_cache_state", "_def_cache_on", "_remembered", "_remembered_state",
...
def _copy_world(source: SdkWorld) -> SdkWorld:
    ...
    world.__dict__.update(
        ...
        _record_seq=source._record_seq, _type_props=source._type_props, _private=source._private, _hidden=source._hidden, hidden_reads=0,
