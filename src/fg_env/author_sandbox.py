...
for the next call), so the author's session always goes on and says which step was too slow::
    ...
    with Sandbox() as box:
        text = box.call("fg_env.authoring:_tool", {"name": "check", "path": "contract.json", "args": {}}, seconds=60)
...
class Sandbox:
    ...
    def start(self) -> subprocess.Popen:
        ...
        process = subprocess.Popen([sys.executable, "-c", "from fg_env.author_sandbox import main; main()"],
